<?php
	...
	function form($val = ''){
	echo "<form action=task4.php' method='GET' class='search-form' id='task4'>";
	echo "<input type='text' name='search' class='search-form-input' value='$val' placeholder='Введите страну'/>";
	echo "<button class='search-form-button'>Поиск</button></form>";
	}
	...
	elseif(isset($_GET['search'])): sqlQuery($con, $_GET['search']);
	else: form();
	endif;
